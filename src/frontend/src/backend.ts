...
export class Backend implements backendInterface {
    ...
    async createBlogPost(arg0: BlogPostInput): Promise<bigint> {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateBlogPost(arg0: bigint, arg1: BlogPostInput): Promise<boolean> {
        if (this.processError) {
            try {
