  ...
  return (
    ...
    >
      ...
      {showTooltip && !dismissed && (
        <div className="relative glass-effect rounded-2xl px-4 py-3 shadow-elevated max-w-[200px] border-glow animate-slide-up">
          <button
            type="button"
      ...
      {/* Main button — min 56px for easy tap on mobile */}
      <a
        href={whatsappUrl}
        target="_blank"
      ...
      >
        ...
        <span className="absolute inset-0 rounded-full bg-white/10 opacity-0 group-hover:opacity-100 transition-smooth" />
      </a>
    </div>
  );
}
