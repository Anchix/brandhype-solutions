...
export default function ServiceLinkedIn() {
  useEffect(() => {
    document.title =
      "LinkedIn Marketing Agency India | B2B Lead Generation | BrandHype Solutions";
  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, #0a0a0a 0%, #080c14 60%, #0a0a0a 100%)",
        }}
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            Thought leadership, lead generation, and B2B brand building — for
            Indian brands that want to be taken seriously on the world's most
          ...
          >
            BrandHype Solutions helps Indian brands and founders build LinkedIn
            presence that generates real business outcomes — not just follower
            counts. Whether you're a SaaS company generating enterprise leads, a
            founder building personal authority, or a B2B brand trying to reach
            decision-makers across India, we build the LinkedIn engine that
            works for you.
          </p>
          <button
            type="button"
          ...
          >
            Get a Free LinkedIn Profile Audit →
          </button>
        </div>
      </section>
      ...
      >
        <div className="max-w-3xl mx-auto">
          <h2 className="section-heading text-white mb-6 text-center">
            Why LinkedIn for{" "}
            <span className="gradient-text-blue-purple">Indian Brands?</span>
          </h2>
          <div
          ...
          >
            ...
            >
              India now has the world's 3rd largest LinkedIn user base — over
              100 million professionals. Indian decision-makers research
              vendors, evaluate partners, and discover new tools on LinkedIn
              before they ever visit a website. If your brand isn't present and
              credible on LinkedIn, you're invisible to a huge segment of
              high-value buyers.
            </p>
      ...
      <section className="section-padding px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            End-to-end LinkedIn growth for brands and founders.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <div className="flex items-start gap-3 mb-4">
              ...
              >
                A Mumbai B2B SaaS company had 800 LinkedIn followers and zero
                inbound from the platform. After 6 months of our LinkedIn
                strategy, they had 12,400 followers, 3 enterprise contracts
                closed from LinkedIn outreach, and the founder had become a
                recognized voice in the Indian SaaS community.
              </p>
            </div>
            <button
              type="button"
