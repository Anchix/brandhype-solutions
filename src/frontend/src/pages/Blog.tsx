...
// Primary display categories for filter bar (these always show; others only if posts exist in them)
...
export function backendToDisplay(post: BackendPost): BlogPost {
  return {
    ...
    author:
      post.author && post.author !== "farhatnazneen95@gmail.com"
        ? post.author
        : "BrandHype Solutions",
    tags: post.tags
      ? post.tags
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 sm:p-10 w-full">
        ...
        <h2 className="font-display font-black text-2xl sm:text-4xl lg:text-5xl text-white leading-tight mb-3 max-w-3xl">
          {post.title}
        </h2>
...
export default function Blog() {
  ...
  // Show primary categories always, then any extra categories that have posts
