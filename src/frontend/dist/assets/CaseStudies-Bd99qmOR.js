import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, T as TrendingUp, Z as Zap, B as Button, C as ChevronDown, a as Users } from "./index-DNS5gUxP.js";
/**
...
const CASE_STUDIES = [
  {
    ...
    problem: "Lenskart needed to break through a crowded eyewear market and drive online sales among Gen Z and millennials (18–34). Traditional advertising was expensive with diminishing returns — CAC was ₹420/customer, ROAS sat below 2.5x, and organic reach was stagnant. The brand lacked virality and strong social proof on Instagram and YouTube.",
    strategy: [
  ...
  },
  {
    ...
    problem: "Swiggy needed a regional brand awareness push in Tier 2 and Tier 3 cities where Zomato had stronger mindshare. The challenge: build emotional resonance with a price-sensitive, diverse audience while reinforcing the 'fast delivery + variety' promise. Unaided brand recall in target cities was 32% vs Zomato's 58%.",
    strategy: [
  ...
  },
  {
    ...
    problem: "Snitch, a fast-fashion D2C brand targeting men (18–30), needed to scale its digital marketing to compete with Bewakoof and The Souled Store. Despite strong product-market fit, marketing efficiency was broken — ROAS was 1.8x (unprofitable), cart abandonment was 74%, and retargeting was unstructured. Overall digital CAC: ₹680.",
    strategy: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-14 h-14 rounded-xl glass-effect flex items-center justify-center overflow-hidden flex-shrink-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        "aria-hidden": "true",
                        children: cs.brand.charAt(0)
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-white truncate", children: cs.brand }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border ${styles.badge}`,
                          children: cs.campaignType
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm font-semibold ${styles.text}`, children: cs.tagline })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
              ...
              !expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex flex-wrap gap-3", children: cs.metrics.filter((m) => m.highlight).map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `flex items-center gap-2 px-3 py-1.5 rounded-lg border ${styles.metric}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: `w-3.5 h-3.5 ${styles.text}` }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-white/60", children: [
                      m.label,
                      ":"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-sm font-bold ${styles.text}`, children: m.value })
                  ]
                },
                m.label
              )) })
        ...
        expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 sm:px-8 pb-8 space-y-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-lg bg-red-500/10 border border-red-500/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-4 h-4 text-red-400" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-base text-white", children: "Problem" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/60 leading-relaxed", children: cs.problem })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: `w-4 h-4 ${styles.text}` })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-base text-white", children: "Strategy" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: cs.strategy.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 text-emerald-400" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-base text-white", children: "Execution" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: cs.execution.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  className: "flex gap-2 text-sm text-white/60 leading-relaxed",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1.5 w-1.5 h-1.5 rounded-full bg-emerald-400/60 flex-shrink-0" }),
                    item
                  ]
                },
                item
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-5 rounded-full bg-gradient-to-b from-primary to-secondary inline-block" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-base text-white", children: "Results" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `text-xs font-semibold px-2 py-0.5 rounded-full border ${styles.badge}`,
                  children: cs.highlight
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3", children: cs.metrics.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `p-4 rounded-xl border transition-smooth ${m.highlight ? `${styles.metric} ${styles.border}` : "bg-white/[0.03] border-white/10"}`,
                "data-ocid": `case_studies.${cs.id}_metric`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40 mb-1 leading-tight", children: m.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `font-display font-bold text-lg ${m.highlight ? styles.text : "text-white"}`,
                      children: m.value
                    }
                  )
                ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/40", children: "Want results like these for your brand?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
...
function CaseStudies() {
  ...
  const filtered = activeFilter === "all" ? CASE_STUDIES : CASE_STUDIES.filter((cs) => cs.campaignType === activeFilter);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      id: "case-studies",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-0 w-[500px] h-[500px] bg-primary/5 blur-[120px] rounded-full pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 right-0 w-[400px] h-[400px] bg-secondary/5 blur-[100px] rounded-full pointer-events-none" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8 sm:mb-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-effect border border-primary/20 text-primary text-xs font-semibold mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading text-white mb-4", children: [
              "Our Results ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-blue-purple", children: "Speak" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading max-w-xl mx-auto", children: "Real campaigns. Real numbers. Real growth." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `px-4 py-2 rounded-full text-sm font-medium transition-smooth min-h-[36px] ${activeFilter === f.value ? "bg-primary text-white glow-blue border border-primary/50" : "glass-effect border border-white/10 text-white/60 hover:text-white hover:border-white/20"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-5", "data-ocid": "case_studies.list", children: filtered.map((cs, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `case_studies.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CaseStudyCard, { cs }) }, cs.id)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 md:mt-14 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card border border-white/10 p-8 sm:p-12 max-w-3xl mx-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 text-accent text-xs font-semibold mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3 h-3" }),
              "Your Brand Next"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-bold text-2xl sm:text-3xl text-white mb-3", children: [
              "Ready to Write Your",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-gold", children: "Success Story?" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 text-sm sm:text-base mb-7 max-w-lg mx-auto", children: "From D2C brands to SaaS platforms — we engineer growth with data-driven campaigns, influencer playbooks, and performance marketing built for scale." }),
